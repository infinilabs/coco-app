    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "h-[var(--cell-size)] w-[var(--cell-size)] select-none p-0 aria-disabled:opacity-50 pointer-events-auto",
        ...
        dropdown: cn(
          "bg-transparent outline-none text-sm w-full p-2 cursor-pointer appearance-none",
